...
import com.tabonfurniture.dto.PasswordResetRequest;
import com.tabonfurniture.service.UserService;
import com.tabonfurniture.service.EmailService;
...
public class AuthController {
    ...
    public String processLogin(@Valid @ModelAttribute LoginRequest loginRequest,
        ...
        try {
            ...
            if (user.getRole() == com.tabonfurniture.entity.User.Role.ADMIN) {
