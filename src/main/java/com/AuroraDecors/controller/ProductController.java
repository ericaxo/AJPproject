...
import com.AuroraDecors.entity.Review;
...
public class ProductController {
    ...
    com.AuroraDecors.entity.User user = null;
    Object userObj = session.getAttribute("loggedInUser");
    if (userObj != null && userObj instanceof com.AuroraDecors.dto.UserResponse userResponse) {
